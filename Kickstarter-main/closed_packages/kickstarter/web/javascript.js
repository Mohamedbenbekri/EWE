...
function view_boxes(menu) {
    ...
    var ewego_router_visibility = "hidden";
    switch (menu) {
        case "status":
        ...
        case "help":
            ...
            break;
        case "ewego_router":
            ewego_router_display = "block";
            ewego_router_visibility = "visible";
            break;
    }
    ...
    root.style.setProperty('--box_ewego_router_display', ewego_router_display);
    root.style.setProperty('--box_ewego_router_visibility', ewego_router_visibility);
...
function refresh(){
    //Hier muss ich einfahce die richtige Methode anwenden um die Infos von arp tabelle zu bekommen dafür
    var ip ="192.168.1.1";
